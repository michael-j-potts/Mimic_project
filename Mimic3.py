...
def threedigiticd(codes):
    if isinstance(codes, list):
        print(codes)
        return [code for code in codes if code.isdigit()][:3]
    else:
        return []
    
    
Admissions = pd.read_csv("C:\\Users\\micha\\Documents\\Data science projects\\Mimic_datasets\\ADMISSIONS.csv")
Diagnoses = pd.read_csv("C:\\Users\\micha\\Documents\\Data science projects\\Mimic_datasets\\DIAGNOSES_ICD.csv")
Labs = pd.read_csv("C:\\Users\\micha\\Documents\\Data science projects\\Mimic_datasets\\LABEVENTS.csv")
Patients = pd.read_csv("C:\\Users\\micha\\Documents\\Data science projects\\Mimic_datasets\\PATIENTS.csv")
#Prescriptions = pd.read_csv("C:\\Users\\micha\\Documents\\Data science projects\\Mimic_datasets\\PRESCRIPTIONS.csv")

Dataset = pd.DataFrame()
Dataset['PatientID'] = Patients['SUBJECT_ID']
